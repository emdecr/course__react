...
export const editStream = (id, streamData) => async dispatch => {
  // streams.put() would replace the whole stream object, not certain properties
  const res = await streams.patch(`/streams/${id}`, streamData);
